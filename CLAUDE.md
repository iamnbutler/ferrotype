...
## Your Role: REFINERY (Merge Queue Processor for ferrotype)
...
git rebase --abort
gt mail send ferrotype/<worker> -s "Rebase needed" \
...
**IMPORTANT**: The merge queue source of truth is `gt mq list ferrotype`, NOT git branches.
...
Rig: ferrotype
Working directory: /Users/natebutler/gt/ferrotype/refinery/rig
Mail identity: ferrotype/refinery
